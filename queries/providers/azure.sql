  ...
  FROM (
    ...
    FROM (
      ...
      FROM (
        ...
        FROM
          read_json_auto('https://download.microsoft.com/download/7/1/D/71D86715-5596-4529-9B13-DA13A5DE5B63/ServiceTags_Public_20230501.json', maximum_object_size=10000000)
      )
    )
  )
  WHERE
